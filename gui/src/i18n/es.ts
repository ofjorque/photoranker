...
export const es: Record<string, string> = {
  ...
  'tournament.scope.label': 'Acotar por subcarpeta',
  'tournament.scope.placeholder': 'ej. Día 1',
  'tournament.scope.apply': 'Aplicar',
  'tournament.scope.clear': 'Quitar scope "{scope}"',
  ...
  'home.duplicates.title': 'Posibles duplicados entre carpetas',
  'home.duplicates.description': 'Compara el hash de esta carpeta contra las demás ya sincronizadas al índice global — no toca nada, solo informa.',
  'home.duplicates.button': 'list-duplicates',
  'home.duplicates.none': 'No se encontraron posibles duplicados.',
  'home.duplicates.found': '{count} posible(s) duplicado(s) encontrados',
  'home.duplicates.row': '{local} ↔ {other}',
  'home.duplicates.exact': 'idéntica',
  ...
  'variables.classifier.exit': 'Salir',
  'variables.classifier.prevPage': '← Anterior',
  'variables.classifier.nextPage': 'Siguiente →',
  'variables.classifier.page': 'Página {page}/{total}',
